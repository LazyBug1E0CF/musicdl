# player-volume-control Specification

## Purpose

Provide an interactive volume control in the bottom player with click-to-set and drag-to-adjust volume bar, mute toggle, and responsive popup on narrow viewports.
